    ...
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        if (paymentIntent != null) {
          ...
          // Note: This will fail without a room ID. 
          // In production, you should get the room from the tenant's current assignment
          Fluttertoast.showToast(
            msg: 'Payment processing simulated. Contact admin to complete payment with room assignment.',
