...
//   // ✅ Login Form Controllers - PRESERVED ACROSS ALL REBUILDS
...
//   // ✅ Register Form Controllers - PRESERVED ACROSS ALL REBUILDS
...
//   // ✅ IMPROVED NOTIFICATION SYSTEM - Multiple fallbacks
//   void _showNotification(String message, {bool isError = false}) {
//     if (!mounted) return;
    
//     debugPrint('🔔 Notification: $message (isError: $isError)');
    
//     // METHOD 1: SnackBar with ScaffoldMessenger (Most Reliable)
//     try {
...
//       );
//     } catch (e) {
//       debugPrint('❌ Fluttertoast failed: $e');
//     }

//     // METHOD 3: Custom Overlay (Last Resort)
//     try {
...
//               decoration: BoxDecoration(
//                 color: isError ? AppColors.red500 : AppColors.secondaryTeal,
//                 borderRadius: BorderRadius.circular(12),
//                 boxShadow: [
//                   BoxShadow(
...
//       });
//     } catch (e) {
//       debugPrint('❌ Overlay failed: $e');
//     }
//   }

//   // ✅ COMPLETELY REWRITTEN LOGIN HANDLER
//   Future<void> _handleLogin() async {
//     // Prevent multiple simultaneous requests
//     if (_isProcessing) {
//       debugPrint('⚠️ Login already in progress, ignoring request');
//       return;
//     }

//     if (!_loginFormKey.currentState!.validate()) {
//       _showNotification('Please fill in all required fields correctly', isError: true);
//       return;
//     }
...
//       // ✅ STORE CREDENTIALS BEFORE API CALL (NEVER CLEAR THESE)
...
//         debugPrint('🧹 Login form cleared after success');
...
//         // Only hide password for security
//         setState(() {
//           _loginPasswordVisible = false;
//         });
...
//         debugPrint('📝 Login credentials preserved for retry');
//       }
//     } catch (e) {
...
//           _loginPasswordVisible = false;
//         });
//         _showNotification('An error occurred. Please try again.', isError: true);
//       }
//     } finally {
//       if (mounted) {
//         setState(() {
...
//   // ✅ COMPLETELY REWRITTEN REGISTER HANDLER
//   Future<void> _handleRegister() async {
//     // Prevent multiple simultaneous requests
//     if (_isProcessing) {
//       debugPrint('⚠️ Registration already in progress, ignoring request');
//       return;
//     }
...
//       // ✅ STORE DATA BEFORE API CALL (NEVER CLEAR THESE)
...
//       final role = _registerSelectedRole;
...
//         debugPrint('🧹 Registration form cleared after success');
        
//         // Switch to login tab
//         _switchTab(0);
        
//         // Transfer email to login form for convenience
...
//         debugPrint('📝 Registration credentials preserved for retry');
//       }
//     } catch (e) {
...
//                   // ✅ FORMS PRESERVED IN PAGEVIEW - STATE MAINTAINED
//                   Expanded(
//                     child: Container(
//                       margin: const EdgeInsets.symmetric(horizontal: 24),
//                       decoration: BoxDecoration(
...
//                         onChanged: _isProcessing ? null : (value) => setState(() => _loginRememberMe = value ?? false),
...
//                   child: CustomButton(
//                     text: 'Login',
//                     onPressed: (_isProcessing || authProvider.state == AuthState.loading) ? null : _handleLogin,
//                     isGradient: true,
//                     isLoading: _isProcessing || authProvider.state == AuthState.loading,
//                   ),
//                 ),
...
//                   ],
//                   onChanged: _isProcessing ? null : (value) => setState(() => _registerSelectedRole = value ?? 'user'),
//                   decoration: InputDecoration(
...
//                         onChanged: _isProcessing ? null : (value) => setState(() => _registerAgreeToTerms = value ?? false),
//                         activeColor: AppColors.primaryBlue,
//                       ),
//                     ),
//                     const SizedBox(width: 8),
...
//                   child: CustomButton(
//                     text: 'Create Account',
//                     onPressed: (_isProcessing || authProvider.state == AuthState.loading) ? null : _handleRegister,
//                     isGradient: true,
//                     isLoading: _isProcessing || authProvider.state == AuthState.loading,
//                   ),
//                 ),
