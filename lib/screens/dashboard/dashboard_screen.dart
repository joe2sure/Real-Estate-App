...
import 'package:Peeman/providers/occupancy_provider.dart'; // New provider for occupancy
import 'package:Peeman/providers/revenue_analytics_provider.dart'; // New provider for revenue analytics
import 'package:Peeman/screens/dashboard/occupancy_card.dart'; // New widget
import 'package:Peeman/screens/dashboard/payment_trends_chart.dart'; // New widget
import 'package:Peeman/screens/dashboard/revenue_chart.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider(create: (_) => OccupancyProvider()..fetchOccupancyData(context)), // New
        ChangeNotifierProvider(create: (_) => RevenueAnalyticsProvider()..fetchRevenueAnalytics(context)), // New
      ],
      child: Scaffold(
