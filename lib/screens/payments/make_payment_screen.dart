...
class _MakePaymentScreenState extends State<MakePaymentScreen> {
  ...
  void _handlePayment() async {
    if (_formKey.currentState!.validate()) {
      ...
      if (_selectedMethod == 'credit_card') {
        ...
        // Handle other payment methods - Note: You'll need room and other required fields
        Fluttertoast.showToast(
          msg: 'This payment method requires additional information. Please contact admin.',
  ...
  Widget _buildPaymentMethodInfo(IconData icon, String title, String description) {
    return Padding(
